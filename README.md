...
The systems are customized for [Python 3.5.4](https://www.python.org/) changing the original systems developed for [Python 2.7.0](https://www.python.org/). Currently, this forked baseline system is tested only by [Miniconda with Python 3.6](https://conda.io/miniconda.html) on macOS High Sierra (Version 10.13.2) and [CentOS 6.9](https://www.centos.org).

Run to ensure that all external modules are installed

    conda create -n py3 python=3.5
    source activate py3
    conda install -c conda-forge scipy numpy scikit-learn=0.16.1 pyyaml librosa=0.4.3
